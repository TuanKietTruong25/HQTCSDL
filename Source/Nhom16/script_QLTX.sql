...
GO
ALTER TABLE [LICHTRINH]  WITH CHECK ADD  CONSTRAINT [FK_LICHTRINH_QUANLY] FOREIGN KEY([NGUOICHINHSUACUOICUNG])
REFERENCES [QUANLY] ([MA])
GO
ALTER TABLE [LICHTRINH] CHECK CONSTRAINT [FK_LICHTRINH_QUANLY]
GO
...
GO
ALTER TABLE [LICHTRINH]  WITH CHECK ADD  CONSTRAINT [FK_LICHTRINH_TAIXE1] FOREIGN KEY([NGUOICHINHSUACUOICUNG])
REFERENCES [TAIXE] ([MA])
GO
ALTER TABLE [LICHTRINH] CHECK CONSTRAINT [FK_LICHTRINH_TAIXE1]
GO
